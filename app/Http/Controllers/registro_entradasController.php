...
class registro_entradasController extends Controller
{
    ...
    {
        $response = Http::get('https://io.adafruit.com/api/v2/CarlosLpz/feeds/codigosnfc/data?limit=1&X-AIO-Key=aio_yuzQ94Ha5HqamY60HULORpX6fZBZ');
        ...
        foreach($posts as $post)
        {
            ...
            if (User::where('LlaveIngreso', $post->value)->exists()) {
                ...
                $response = Http::withHeaders([
                    'X-AIO-Key' => 'aio_yuzQ94Ha5HqamY60HULORpX6fZBZ'
    ...
    public function ConsultarEntradas()
    {
        ...
        $response = Http::get('https://io.adafruit.com/api/v2/CarlosLpz/feeds/codigosnfc/data?limit=10&X-AIO-Key=aio_qhQi79wEQsIQnJSY9jIqnnj6Nyl8');
        $posts=json_decode($response->body());
